...
**샤이닝패스**와 정식 계약을 맺고 SaaS(웹 + UE5 클라이언트)를 개발·납품했습니다.

| | |
|:--|:--|
| 발주처 | 샤이닝패스 |
| 참여 사업 | 실내 마감재 시뮬레이션 서비스 |
| 참여 기간 | 2025.02.03 ~ 2026.04.08 |
| 역할 | 프리랜서 개발자 |
| 담당 | SW개발 · 응용SW개발 |

> [!NOTE]
> 증명서의 참여사업명은 행정상 등록된 "실내 마감재 시뮬레이션 서비스" 한 줄이지만, 실제 계약 범위는 공식 홈페이지·백엔드·인프라부터 UE5 클라이언트까지 이 페이지 전체입니다. 아래는 그 경력을 뒷받침하는 **한국인공지능소프트웨어산업협회(KOSA, 구 한국소프트웨어산업협회)** 소프트웨어기술자 경력증명서입니다.

<p align="center">
  <img src="assets/certificate-kosa.png" width="720" alt="KOSA 소프트웨어기술자 경력증명서" />
</p>

「소프트웨어 진흥법」 제24조제3항 및 같은 법 시행규칙 제13조제3항에 따라 발급된 문서입니다.

## 코리아빌드위크 참가

이 프로젝트를 앞세워 신규 고객사 유치에 성공했고, 서울 **킨텍스(KINTEX)**에서 열린 건축 박람회 **코리아빌드위크(Korea Build Week)**에도 참가했습니다.

박람회 현장에서 대형 터치스크린으로 UE5 클라이언트를 직접 시연하며 건축사·엔지니어·CM 관계자들에게 제품을 소개했습니다.

<p align="center">
  <img src="assets/korea-build-week-badge.jpg" width="360" alt="코리아빌드위크 참가자 출입증" />
</p>

<p align="center">
  <img src="assets/korea-build-week-booth.jpg" width="900" alt="코리아빌드위크 부스 시연 현장" />
</p>
---
