...
<div align="center">
  ...
  <p>
    ...
    <strong>Unreal Engine 5 Game Developer</strong>
  </p>
  
  <p><em>Scalable systems, intelligent automation, and immersive games — I build them with passion.</em></p>
  
  <a href="https://github.com/DW-dev-UE">
    <img src="https://img.shields.io/github/followers/DW-dev-UE?label=Followers&style=social" alt="GitHub followers"/>
  </a>
  <img src="https://komarev.com/ghpvc/?username=DW-dev-UE&style=flat-square&color=0abf8a" alt="Profile views"/>
</div>

---

### About Me
Passionate Full Stack & AI Developer with strong expertise in **Unreal Engine 5** game development, **Python** backend systems, AI automation, and cloud architecture. I enjoy building scalable applications, optimizing performance, and delivering real-world solutions through personal projects and freelance work.
...
- 💼 **[ABadOmic Project (Freelance)](https://github.com/DW-dev-UE/DevLOG/blob/main/ABadOmic-Freelance.md)** — 프리랜서 클라이언트 프로젝트
...
- 🏡 **[ShiningPass: Planterior-AI](https://github.com/DW-dev-UE/Planterior-AI/blob/main/README.md)** — AI 모델부터 백엔드 서버, 디지털 트윈까지
